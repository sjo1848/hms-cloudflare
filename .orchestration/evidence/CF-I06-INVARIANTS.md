...
Artifact candidate: CF-I06 REWORK-1, populated immediately before publication.
...
| INV-RESP-001 | PROVEN | Playwright scroll width equals viewport at 375, 390, 430, 768 and 1024; validation, typed overpay and stale-close errors are exercised |
| INV-EVID-001 | PROVEN | focal regression, unit tests, typecheck, web build and browser artifact pass; inherited accepted evidence is mechanically identity-preserving and recorded in gate |
...
Inherited accepted CF-I03/04/05 product/test blobs remain mechanically identity-preserving from their accepted artifacts; no CF-I03/04/05 source or test blob changed in this REWORK. The local runner lifecycle limitation is not relabeled as a new execution PASS.
